...
// READ: 字符串 <https://cppreference.cn/w/cpp/string/basic_string>
...
int main(int argc, char **argv) {
    // READ: 字符串字面量 <https://cppreference.cn/w/cpp/string/basic_string/operator%22%22s>
    using namespace std::string_literals;
    auto hello = "Hello"s;
    auto world = "world";
    // READ: `decltype` 表达式 <https://cppreference.cn/w/cpp/language/decltype>
    // READ: `std::is_same_v` 元编程判别 <https://cppreference.cn/w/cpp/types/is_same>
